(() => {
  ...
  // ../crematic/node_modules/react/cjs/react.development.js
  var require_react_development = __commonJS({
    "../crematic/node_modules/react/cjs/react.development.js"(exports, module) {
      "use strict";
      if (true) {
        (function() {
          "use strict";
  ...
  // ../crematic/node_modules/react/index.js
  var require_react = __commonJS({
    "../crematic/node_modules/react/index.js"(exports, module) {
      "use strict";
      if (false) {
        module.exports = null;
      } else {
  ...
  // ../rexcre/node_modules/react-pro-sidebar/dist/index.es.js
  ...
  var registerStyles$1 = function registerStyles(cache, serialized, isStringTag) {
    ...
    if ((isStringTag === false || isBrowser$4 === false && cache.compat !== void 0) && cache.registered[className] === void 0) {
...
https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals#ES2018_revision_of_illegal_escape_sequences`;
  ...
  var EmotionCacheContext = /* @__PURE__ */ (0, import_react.createContext)(typeof HTMLElement !== "undefined" ? /* @__PURE__ */ createCache({
    key: "css"
  }) : null);
  if (true) {
  ...
  var Emotion = /* @__PURE__ */ withEmotionCache(function(props, cache, ref) {
    ...
    return /* @__PURE__ */ (0, import_react.createElement)(import_react.Fragment, null, /* @__PURE__ */ (0, import_react.createElement)(Insertion$1, {
      cache,
      serialized,
  ...
  var registerStyles2 = function registerStyles3(cache, serialized, isStringTag) {
    var className = cache.key + "-" + serialized.name;
    if ((isStringTag === false || isBrowser$1 === false && cache.compat !== void 0) && cache.registered[className] === void 0) {
      cache.registered[className] = serialized.styles;
    }
  };
...
https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals#ES2018_revision_of_illegal_escape_sequences`;
  ...
  var createStyled = function createStyled2(tag, options) {
    ...
    return function() {
      ...
      var Styled = withEmotionCache(function(props, cache, ref) {
        ...
        newProps.className = className;
        newProps.ref = ref;
        return /* @__PURE__ */ (0, import_react.createElement)(import_react.Fragment, null, /* @__PURE__ */ (0, import_react.createElement)(Insertion2, {
          cache,
          serialized,
  ...
  var Sidebar = import_react.default.forwardRef(function(_a, ref) {
    ...
    return import_react.default.createElement(SidebarContext.Provider, { value: { collapsed: collapsedValue, toggled: toggledValue, rtl, transitionDuration } }, import_react.default.createElement(StyledSidebar, __assign({ ref, "data-testid": "".concat(sidebarClasses.root, "-test-id"), rtl, rootStyles, width, collapsedWidth, transitionDuration, className: classnames(sidebarClasses.root, (_b = {}, _b[sidebarClasses.collapsed] = collapsedValue, _b[sidebarClasses.toggled] = toggledValue, _b[sidebarClasses.broken] = broken, _b[sidebarClasses.rtl] = rtl, _b), className) }, rest), import_react.default.createElement(StyledSidebarContainer, { "data-testid": "".concat(sidebarClasses.container, "-test-id"), className: sidebarClasses.container, backgroundColor }, children), image && import_react.default.createElement(StyledSidebarImage, { "data-testid": "".concat(sidebarClasses.image, "-test-id"), src: image, alt: "sidebar background", className: sidebarClasses.image }), broken && toggledValue && import_react.default.createElement(StyledBackdrop, { "data-testid": "".concat(sidebarClasses.backdrop, "-test-id"), role: "button", tabIndex: 0, "aria-label": "backdrop", onClick: handleBackdropClick, onKeyPress: handleBackdropClick, className: sidebarClasses.backdrop })));
  });
  ...
  var MenuFR = function(_a, ref) {
    ...
    return import_react.default.createElement(MenuContext.Provider, { value: providerValue }, import_react.default.createElement(LevelContext.Provider, { value: 0 }, import_react.default.createElement(StyledMenu, __assign({ ref, className: classnames(menuClasses.root, className), rootStyles }, rest), import_react.default.createElement(StyledUl, null, children))));
  };
  ...
  var SubMenuContentFR = function(_a, ref) {
    ...
    return import_react.default.createElement(StyledSubMenuContent, __assign({ "data-testid": "".concat(menuClasses.subMenuContent, "-test-id"), ref, firstLevel, collapsed, open, openWhenCollapsed, transitionDuration, defaultOpen: defaultOpenState }, rest), import_react.default.createElement(StyledUl, null, children));
  };
  ...
  var SubMenuFR = function(_a, ref) {
    ...
    return import_react.default.createElement(StyledSubMenu, { ref, className: classnames(menuClasses.menuItemRoot, menuClasses.subMenuRoot, sharedClasses, className), menuItemStyles: getSubMenuItemStyles("root"), level, collapsed, rtl, disabled, active, buttonStyles: getSubMenuItemStyles("button"), rootStyles }, import_react.default.createElement(MenuButton, __assign({ "data-testid": "".concat(menuClasses.button, "-test-id"), ref: buttonRef, title, className: classnames(menuClasses.button, sharedClasses), onClick: handleOnClick, onKeyUp: handleOnKeyUp, component, tabIndex: 0 }, rest), icon && import_react.default.createElement(StyledMenuIcon, { rtl, className: classnames(menuClasses.icon, sharedClasses), rootStyles: getSubMenuItemStyles("icon") }, icon), prefix2 && import_react.default.createElement(StyledMenuPrefix, { collapsed, transitionDuration: sidebarTransitionDuration, firstLevel: level === 0, className: classnames(menuClasses.prefix, sharedClasses), rtl, rootStyles: getSubMenuItemStyles("prefix") }, prefix2), import_react.default.createElement(StyledMenuLabel, { className: classnames(menuClasses.label, sharedClasses), rootStyles: getSubMenuItemStyles("label") }, label), suffix && import_react.default.createElement(StyledMenuSuffix, { collapsed, transitionDuration: sidebarTransitionDuration, firstLevel: level === 0, className: classnames(menuClasses.suffix, sharedClasses), rootStyles: getSubMenuItemStyles("suffix") }, suffix), import_react.default.createElement(StyledExpandIconWrapper, { rtl, className: classnames(menuClasses.SubMenuExpandIcon, sharedClasses), collapsed, level, rootStyles: getSubMenuItemStyles("SubMenuExpandIcon") }, renderExpandIcon ? renderExpandIcon({
      level,
      disabled,
      active,
      open: openControlled !== null && openControlled !== void 0 ? openControlled : open
    }) : collapsed && level === 0 ? import_react.default.createElement(StyledExpandIconCollapsed, null) : import_react.default.createElement(StyledExpandIcon, { rtl, open: openControlled !== null && openControlled !== void 0 ? openControlled : open }))), import_react.default.createElement(SubMenuContent, { ref: contentRef, openWhenCollapsed, open: openControlled !== null && openControlled !== void 0 ? openControlled : open, firstLevel: level === 0, collapsed, defaultOpen: openControlled && !mounted || defaultOpen, className: classnames(menuClasses.subMenuContent, sharedClasses), rootStyles: getSubMenuItemStyles("subMenuContent") }, import_react.default.createElement(LevelContext.Provider, { value: level + 1 }, children)));
  };
  ...
  var MenuItemFR = function(_a, ref) {
    ...
    return import_react.default.createElement(StyledMenuItem, { ref, className: classnames(menuClasses.menuItemRoot, sharedClasses, className), menuItemStyles: getMenuItemStyles("root"), level, collapsed, rtl, disabled, active, buttonStyles: getMenuItemStyles("button"), rootStyles }, import_react.default.createElement(MenuButton, __assign({ className: classnames(menuClasses.button, sharedClasses), "data-testid": "".concat(menuClasses.button, "-test-id"), component, tabIndex: 0 }, rest), icon && import_react.default.createElement(StyledMenuIcon, { rtl, className: classnames(menuClasses.icon, sharedClasses), rootStyles: getMenuItemStyles("icon") }, icon), prefix2 && import_react.default.createElement(StyledMenuPrefix, { collapsed, transitionDuration, firstLevel: level === 0, className: classnames(menuClasses.prefix, sharedClasses), rtl, rootStyles: getMenuItemStyles("prefix") }, prefix2), import_react.default.createElement(StyledMenuLabel, { className: classnames(menuClasses.label, sharedClasses), rootStyles: getMenuItemStyles("label") }, children), suffix && import_react.default.createElement(StyledMenuSuffix, { collapsed, transitionDuration, firstLevel: level === 0, className: classnames(menuClasses.suffix, sharedClasses), rootStyles: getMenuItemStyles("suffix") }, suffix)));
  };
 ...
 */
//# sourceMappingURL=custom_sidebar.bundle.XIMSCS4X.js.map
